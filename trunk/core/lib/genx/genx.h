 ...
 */
	typedef struct {
		...
		genxStatus(*sendBounded) (void *userData, constUtf8 start,
								  constUtf8 end);
 ...
 */
	...
	genxStatus genxAddCountedText(genxWriter w, constUtf8 start,
								  int byteCount);
	genxStatus genxAddBoundedText(genxWriter w, constUtf8 start,
								  constUtf8 end);
