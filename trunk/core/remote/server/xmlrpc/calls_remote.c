...
xmlrpc_value *make_call_RP(xmlrpc_env * const env,
	...
	LOG_DEBUG(CALLS_REMOTE_MSG_PREFIX "entering makeCall...");
	...
	LOG_DEBUG(CALLS_REMOTE_MSG_PREFIX "leaving makeCall");
...
xmlrpc_value *end_call_RP(xmlrpc_env * const env,
	...
	LOG_DEBUG(CALLS_REMOTE_MSG_PREFIX "entering endCall...");
	...
	LOG_DEBUG(CALLS_REMOTE_MSG_PREFIX "leaving endCall");
...
xmlrpc_value *accept_call_RP(xmlrpc_env * const env,
	...
	LOG_DEBUG(CALLS_REMOTE_MSG_PREFIX "entering acceptCall...");
	...
	LOG_DEBUG(CALLS_REMOTE_MSG_PREFIX "leaving acceptCall");
	return xmlrpc_build_value(env, "b", result);
}
